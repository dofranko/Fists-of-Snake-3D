...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FAmmoTest, "AmmoTest", EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

bool FAmmoTest::RunTest(const FString& Parameters)
{
	{
